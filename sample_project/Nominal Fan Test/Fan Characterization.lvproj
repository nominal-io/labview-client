...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="DAQ" Type="Folder">
			<Item Name="DAQ Close.vi" Type="VI" URL="../DAQ_SubVIs/DAQ Close.vi"/>
			<Item Name="Fan Acceleration Acquisition.vi" Type="VI" URL="../DAQ_SubVIs/Fan Acceleration Acquisition.vi"/>
			<Item Name="Fan Acceleration Initialization.vi" Type="VI" URL="../DAQ_SubVIs/Fan Acceleration Initialization.vi"/>
			<Item Name="Fan Control Initialization.vi" Type="VI" URL="../DAQ_SubVIs/Fan Control Initialization.vi"/>
			<Item Name="Fan Speed Acquisition.vi" Type="VI" URL="../DAQ_SubVIs/Fan Speed Acquisition.vi"/>
			<Item Name="Fan Speed Initialization.vi" Type="VI" URL="../DAQ_SubVIs/Fan Speed Initialization.vi"/>
			<Item Name="Fan Temperature Acquisition.vi" Type="VI" URL="../DAQ_SubVIs/Fan Temperature Acquisition.vi"/>
			<Item Name="Fan Temperature Initialization.vi" Type="VI" URL="../DAQ_SubVIs/Fan Temperature Initialization.vi"/>
		</Item>
		<Item Name="definitions" Type="Folder">
			<Item Name="State Types.ctl" Type="VI" URL="../Definitions/State Types.ctl"/>
			<Item Name="Test States.ctl" Type="VI" URL="../Definitions/Test States.ctl"/>
		</Item>
